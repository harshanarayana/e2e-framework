...
func TestResourceScaled(t *testing.T) {
	...
	err = For(conditions.New(getResourceManager()).ResourceScaled(deployment, func(object types.Object) int32 {
...
func TestResourceListMatchN(t *testing.T) {
	...
	pods := &v1.PodList{}
	err = For(conditions.New(getResourceManager()).ResourceListMatchN(pods, 5, func(object types.Object) bool {
...
func TestResourcesMatch(t *testing.T) {
	...
	err = For(conditions.New(getResourceManager()).ResourcesMatch(pods, func(object types.Object) bool {
...
func TestResourceMatch(t *testing.T) {
	...
	err = For(conditions.New(getResourceManager()).ResourceMatch(deployment, func(object types.Object) bool {
