...
func (r *Resources) Get(ctx context.Context, name, namespace string, obj types.Object) error {
	return r.client.Get(ctx, cr.ObjectKey{Namespace: namespace, Name: name}, obj)
}

type CreateOption func(*metav1.CreateOptions)

func (r *Resources) Create(ctx context.Context, obj types.Object, opts ...CreateOption) error {
...
func (r *Resources) Update(ctx context.Context, obj types.Object, opts ...UpdateOption) error {
...
func (r *Resources) Delete(ctx context.Context, obj types.Object, opts ...DeleteOption) error {
...
func (r *Resources) List(ctx context.Context, objs types.ObjectList, opts ...ListOption) error {
...
func (r *Resources) Patch(ctx context.Context, objs types.Object, patch types.Patch, opts ...PatchOption) error {
...
func (r *Resources) Annotate(obj types.Object, annotation map[string]string) {
	obj.SetAnnotations(annotation)
}

// Label apply labels to an existing resources.
func (r *Resources) Label(obj types.Object, label map[string]string) {
	obj.SetLabels(label)
}
...
func (r *Resources) Watch(object types.ObjectList, opts ...ListOption) *watcher.EventHandlerFuncs {
	listOptions := &metav1.ListOptions{}
