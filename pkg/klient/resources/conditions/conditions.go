...
func (c *Condition) namespacedName(obj types.Object) string {
...
func (c *Condition) ResourceScaled(obj types.Object, scaleFetcher func(object types.Object) int32, replica int32) apimachinerywait.ConditionFunc {
...
func (c *Condition) ResourceMatch(obj types.Object, matchFetcher func(object types.Object) bool) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
		if err := c.resources.Get(context.TODO(), obj.GetName(), obj.GetNamespace(), obj); err != nil {
			return false, nil
		}
...
func (c *Condition) ResourceListN(list types.ObjectList, n int, listOptions ...resources.ListOption) apimachinerywait.ConditionFunc {
	return c.ResourceListMatchN(list, n, func(object types.Object) bool { return true }, listOptions...)
}
...
func (c *Condition) ResourceListMatchN(list types.ObjectList, n int, matchFetcher func(object types.Object) bool, listOptions ...resources.ListOption) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
		...
		for _, obj := range metaList {
			if o, ok := obj.(types.Object); ok && matchFetcher(o) {
				found++
			} else if !ok {
...
func (c *Condition) ResourcesFound(list types.ObjectList) apimachinerywait.ConditionFunc {
	return c.ResourcesMatch(list, func(object types.Object) bool { return true })
}
...
func (c *Condition) ResourcesMatch(list types.ObjectList, matchFetcher func(object types.Object) bool) apimachinerywait.ConditionFunc {
	metaList, err := meta.ExtractList(list)
	if err != nil {
...
func (c *Condition) ResourcesDeleted(list types.ObjectList) apimachinerywait.ConditionFunc {
	metaList, err := meta.ExtractList(list)
	if err != nil {
		return func() (done bool, err error) { return false, err }
	}
...
func (c *Condition) ResourceDeleted(obj types.Object) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
...
func (c *Condition) JobConditionMatch(job types.Object, conditionType batchv1.JobConditionType, conditionState v1.ConditionStatus) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
...
func (c *Condition) DeploymentConditionMatch(deployment types.Object, conditionType appsv1.DeploymentConditionType, conditionState v1.ConditionStatus) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
...
func (c *Condition) PodConditionMatch(pod types.Object, conditionType v1.PodConditionType, conditionState v1.ConditionStatus) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
...
func (c *Condition) PodPhaseMatch(pod types.Object, phase v1.PodPhase) apimachinerywait.ConditionFunc {
	return func() (done bool, err error) {
...
func (c *Condition) PodReady(pod types.Object) apimachinerywait.ConditionFunc {
...
func (c *Condition) ContainersReady(pod types.Object) apimachinerywait.ConditionFunc {
...
func (c *Condition) PodRunning(pod types.Object) apimachinerywait.ConditionFunc {
...
func (c *Condition) JobCompleted(job types.Object) apimachinerywait.ConditionFunc {
...
func (c *Condition) JobFailed(job types.Object) apimachinerywait.ConditionFunc {
