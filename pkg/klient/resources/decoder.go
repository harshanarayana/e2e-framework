...
type MutateFunc func(obj types.Object) error
...
type HandlerFunc func(ctx context.Context, obj types.Object) error
...
// Options may be provided to configure the behavior of the decoder.
func DecodeAllFiles(ctx context.Context, fsys fs.FS, pattern string, options ...DecodeOption) ([]types.Object, error) {
	objects := []types.Object{}
	err := DecodeEachFile(ctx, fsys, pattern, func(ctx context.Context, obj types.Object) error {
...
func ApplyWithManifestDir(ctx context.Context, r *Resources, dirPath, pattern string, createOptions []CreateOption, options ...DecodeOption) error {
...
func DeleteWithManifestDir(ctx context.Context, r *Resources, dirPath, pattern string, deleteOptions []DeleteOption, options ...DecodeOption) error {
...
// Falls back to the unstructured.Unstructured type if a matching type cannot be found for the Kind.
// Options may be provided to configure the behavior of the decoder.
func DecodeAll(ctx context.Context, manifest io.Reader, options ...DecodeOption) ([]types.Object, error) {
	objects := []types.Object{}
	err := DecodeEach(ctx, manifest, func(ctx context.Context, obj types.Object) error {
		objects = append(objects, obj)
		return nil
	}, options...)
	return objects, err
...
// Falls back to the unstructured.Unstructured type if a matching type cannot be found for the Kind.
// Options may be provided to configure the behavior of the decoder.
func DecodeAny(manifest io.Reader, options ...DecodeOption) (types.Object, error) {
	decodeOpt := &Options{}
	...
	obj, ok := runtimeObj.(types.Object)
	if !ok {
		return nil, err
	}
...
func Decode(manifest io.Reader, obj types.Object, options ...DecodeOption) error {
	decodeOpt := &Options{}
	for _, opt := range options {
		opt(decodeOpt)
	}
...
// after decoding to the object to update the loaded resource.
func DecodeFile(fsys fs.FS, manifestPath string, obj types.Object, options ...DecodeOption) error {
...
// after decoding to the object to update the loaded resource.
func DecodeString(rawManifest string, obj types.Object, options ...DecodeOption) error {
...
func MutateLabels(overrides map[string]string) DecodeOption {
	return MutateOption(func(obj types.Object) error {
...
func MutateOwnerAnnotations(owner types.Object) DecodeOption {
	return MutateOption(func(obj types.Object) error {
...
func CreateHandler(r *Resources, opts ...CreateOption) HandlerFunc {
	return func(ctx context.Context, obj types.Object) error {
...
func ReadHandler(r *Resources, handler HandlerFunc) HandlerFunc {
	return func(ctx context.Context, obj types.Object) error {
		name := obj.GetName()
