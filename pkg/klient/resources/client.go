...
// NewClient returns a new Client value
...
// NewClientWithKubeConfigFile creates a client using the kubeconfig filePath
func NewClientWithKubeConfigFile(filePath string) (Client, error) {
	cfg, err := common.New(filePath)
	if err != nil {
		return nil, err
	}
...
func (c *client) Resources(namespace ...string) *Resources {
